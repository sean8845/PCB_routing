...
routing\_4direction.py: Restricts routing to horizontal and vertical movements only.



routing\_8direction.py: Allows diagonal movements for more efficient and flexible paths.
